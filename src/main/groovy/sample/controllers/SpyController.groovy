...
class SpyController {
    ...
    public @ResponseBody
    String spy(@RequestBody String body, HttpServletRequest request, MongoTemplate mongoTemplate) {
        log.info 'i am spy'
        ...
        result << body
        log.info 'i am body'
        msgTemplate.convertAndSend('/logs/all', result.toString())
        mongoTemplate.insert(new LogEntry().severity(1).data(result))
